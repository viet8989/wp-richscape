...
?>
<a href="<?php the_permalink(); ?>" class="group relative rounded-2xl overflow-hidden shadow-xl aspect-[4/3] md:aspect-[16/9] bg-darkblue cursor-pointer block">
	...
	<div class="absolute bottom-6 left-6 right-6">
		...
		<span class="inline-flex mt-3 text-teal items-center font-bold text-sm uppercase tracking-widest opacity-0 group-hover:opacity-100 transition-all duration-300 transform translate-y-2 group-hover:translate-y-0">
			Xem Dự Án
