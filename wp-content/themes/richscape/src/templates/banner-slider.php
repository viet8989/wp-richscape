...
>
    ...
    <div class="rbs-overlay-card" aria-hidden="true">
        ...
        <p class="rbs-tagline">As Landscape Creators, We Bring<br>Your Green Visions To Life.</p>
        <p class="rbs-body">
            RICHSCAPE mang đến giải pháp thiết kế và thi công<br>
            cảnh quan chuyên nghiệp – từ ý tưởng đến hiện thực.
        </p>
